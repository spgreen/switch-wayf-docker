...
$metadataFile = 'sgaf-metadata-with-proxy-idp-entities.xml';
...
// Set to an empty string to hide the logo
$logoURL = 'https://www.singaren.net.sg/images/Singaren_logo.jpg';
...
// Set to an empty string to hide the logo
$organizationLogoURL = 'https://www.singaren.net.sg/images/SingAREN_logo_clear.png';
